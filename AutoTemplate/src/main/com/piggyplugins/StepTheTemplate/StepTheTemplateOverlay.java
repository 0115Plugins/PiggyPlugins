...
public class StepTheTemplateOverlay extends OverlayPanel {

    private final StepTheTemplatePlugin plugin;

    @Inject
    private StepTheTemplateOverlay(StepTheTemplatePlugin plugin) {
        super(plugin);
        this.plugin = plugin;
