package main.com.piggyplugins.StepTheTemplate;
...
@PluginDescriptor(
        name = "<html><font color=\"#FF9DF9\">[S]</font> Step The Template</html>",
        description = "Step goes Templateing",
        tags = {"ethan", "piggy", "skilling"}
)
public class StepTheTemplatePlugin extends Plugin {
    @Inject
    private Client client;
    @Inject
    StepTheTemplateConfig config;
    @Inject
    private KeyManager keyManager;
    @Inject
    private OverlayManager overlayManager;
    @Inject
    private StepTheTemplateOverlay overlay;
    @Inject
    ...
    @Provides
    private StepTheTemplateConfig getConfig(ConfigManager configManager) {
        return configManager.getConfig(StepTheTemplateConfig.class);
    }
